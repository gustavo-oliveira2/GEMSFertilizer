...
### Gessagem
* Método Textura — Sousa & Lobato (2004): culturas anuais e perenes
* Método V% subsolo — Demattê/Vitti (2008)
* Método Saturação por Ca²⁺ na CTCef — Caires & Guimarães (2018)
* Novos campos de análise de subsolo 20–40 cm
...
* Macronutrientes com nível ótimo
* Gauges de V% e m% com alvo por cultura
* Micronutrientes em % do nível ótimo

### Internacionalização
* Siglas e unidades no padrão internacional (sub/superscrito HTML e Unicode)
* Unidades: cmolc dm⁻³, mg dm⁻³, kg ha⁻¹, dag kg⁻¹
